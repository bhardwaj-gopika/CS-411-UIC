...
def uniformCostSearch(problem):
    ...
    while priorityQueue:
        state, directions, cost = priorityQueue.pop()
        if state in closed:
            continue
        if problem.isGoalState(state):
            break
        ...
        for i in problem.getSuccessors(state):
            priorityQueue.push((i[0], directions+[i[1]], cost+i[2]), cost + i[2])
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while priorityQueue:
        ...
        for i in problem.getSuccessors(state):
            priorityQueue.push((i[0], directions+[i[1]], cost+i[2]), cost+i[2]+heuristic(i[0], problem))
